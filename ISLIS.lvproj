...
<Project Type="Project" LVVersion="17008000">
	<Item Name="My Computer" Type="My Computer">
		...
		<Item Name="Individual" Type="Folder">
			<Item Name="Diameter Tracing.vi" Type="VI" URL="../Individual/Diameter Tracing.vi"/>
			<Item Name="Lipid Quantification.vi" Type="VI" URL="../Individual/Lipid Quantification.vi"/>
			<Item Name="Motion Compensation Metrics.vi" Type="VI" URL="../Individual/Motion Compensation Metrics.vi"/>
			<Item Name="Rotation.vi" Type="VI" URL="../Individual/Rotation.vi"/>
			<Item Name="Stabilize.vi" Type="VI" URL="../Individual/Stabilize.vi"/>
			<Item Name="Updated Motion Metric.vi" Type="VI" URL="../Individual/Updated Motion Metric.vi"/>
			<Item Name="Velocity Tracking.vi" Type="VI" URL="../Individual/Velocity Tracking.vi"/>
		</Item>
		<Item Name="Motion Compensation" Type="Folder">
			<Item Name="StabilizeAll.vi" Type="VI" URL="../Motion Compensation/StabilizeAll.vi"/>
			<Item Name="SubStabilize.vi" Type="VI" URL="../Motion Compensation/SubStabilize.vi"/>
		</Item>
		<Item Name="Support Files" Type="Folder">
			<Item Name="Sound" Type="Folder">
				<Item Name="Diameter.wav" Type="Document" URL="../Support Files/Sound/Diameter.wav"/>
				<Item Name="Rotated.wav" Type="Document" URL="../Support Files/Sound/Rotated.wav"/>
				<Item Name="Stabilized.wav" Type="Document" URL="../Support Files/Sound/Stabilized.wav"/>
				<Item Name="Velocity.wav" Type="Document" URL="../Support Files/Sound/Velocity.wav"/>
			</Item>
			<Item Name="VIs" Type="Folder">
				<Item Name="RectangleToCenter.vi" Type="VI" URL="../Support Files/VIs/RectangleToCenter.vi"/>
			</Item>
		</Item>
		<Item Name="Temp" Type="Folder">
			<Item Name="CalDiaOnlyAll.vi" Type="VI" URL="../Temp/CalDiaOnlyAll.vi"/>
			<Item Name="MotionMetricAll.vi" Type="VI" URL="../Temp/MotionMetricAll.vi"/>
			<Item Name="SubMotionMetric.vi" Type="VI" URL="../Temp/SubMotionMetric.vi"/>
		</Item>
		<Item Name="Vessel Diameter &amp; Cell Velocity" Type="Folder">
			<Item Name="CalDiaVelAll.vi" Type="VI" URL="../Vessel Diameter &amp; Cell Velocity/CalDiaVelAll.vi"/>
			<Item Name="SubDiameter.vi" Type="VI" URL="../Vessel Diameter &amp; Cell Velocity/SubDiameter.vi"/>
			<Item Name="SubVelocity.vi" Type="VI" URL="../Vessel Diameter &amp; Cell Velocity/SubVelocity.vi"/>
		</Item>
		<Item Name="Video Rotation" Type="Folder">
			<Item Name="RotateAll.vi" Type="VI" URL="../Video Rotation/RotateAll.vi"/>
			<Item Name="SubRotate.vi" Type="VI" URL="../Video Rotation/SubRotate.vi"/>
		</Item>
